#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""RawBoost data augmentation for audio deepfake detection.

Implements three augmentation algorithms:
  1. LnL_convolutive_noise - Linear and non-linear convolutive noise
  2. ISD_additive_noise - Impulsive signal-dependent noise
  3. SSI_additive_noise - Stationary signal-independent noise

Reference:
  H. Tak, M. Todisco, X. Wang, J.-w. Jung, J. Yamagishi, N. Evans,
  "Automatic Speaker Verification Spoofing and Deepfake Detection Using
  Wav2Vec 2.0 and Data Augmentation," Proc. Odyssey 2022.
"""
